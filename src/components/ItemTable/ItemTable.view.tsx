...
export default function ItemTableView({contents}: {contents: ModProduct[]}) {
    return (
...
<table className="border-collapse w-full">
    <thead>
        <tr>
            ...
            <th className="p-3 font-bold uppercase bg-gray-200 text-gray-300 text-center border border-gray-300 hidden lg:table-cell">개수</th>
        </tr>
    </thead>
    <tbody>
